package com.adamyaserver.sampleproductmicroservice;
...
class SampleProductMicroserviceApplicationTests {
	...
	private ProductRequest getProductRequest() {
		return ProductRequest.builder().name("test").description("test").price(BigDecimal.valueOf(100)).build();
	}
